...
<!--     <el-dialog
    ...
    <div class="video-container" v-show="videoFlag">
      ...
      <div class="video-bottombar">
        <ul id="pv-buttons">
          <li id="pv-bar-close" class="bar-right bar-button" @click="closeVideo()"><img src="../../../Cloud/src/assets/preview-close.svg" class="img"></li>
          <li id="pv-bar-raw" class="bar-right bar-button" @click="downloadFile(nowVideo.pathsUUID, nowVideo.filename)"><img src="../../../Cloud/src/assets/preview-raw.svg" class="img"></li>
          <li id="pv-bar-next" class="bar-right bar-button"  @click="nextVideo(nowVideoIndex)"><img src="../../../Cloud/src/assets/preview-next.svg" class="img"></li>
          <li id="pv-bar-idx" class="bar-right bar-label">{{nowVideoIndex + 1}}/{{videoArray.length}}</li>
          <li id="pv-bar-prev" class="bar-right bar-button" @click="previousVideo(nowVideoIndex)"><img src="../../../Cloud/src/assets/preview-prev.svg" class="img"></li>
    ...
    <div class="video-container" v-show="editorShow">
      ...
      <div class="video-bottombar">
        <ul id="pv-buttons">
          <li id="pv-bar-close" class="bar-right bar-button" @click="closeText()"><img src="../../../Cloud/src/assets/preview-close.svg" class="img"></li>
          <li id="pv-bar-raw" class="bar-right bar-button" @click="saveText()"><img src="../../../Cloud/src/assets/icon_save_24px_522050_easyicon.net.png" class="img"></li>
